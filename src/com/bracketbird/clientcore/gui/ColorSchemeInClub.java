 ...
 *
 */
public class ColorSchemeInClub implements ColorScheme {

    private final String BASE = "#007D9A";
    private final String BASE_LIGHT = "#3397AE";
    private final String BASE_DARK = "#003F4D";
